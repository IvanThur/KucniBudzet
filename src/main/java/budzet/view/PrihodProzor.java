...
public class PrihodProzor extends javax.swing.JFrame {
    ...
    private void preuzmiVrijednosti() {
        ...
        try {
            ...
            Logger.getLogger(PrihodProzor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        tbPrihod = new javax.swing.JTable();
        ...
        tbPrihod.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbPrihod.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tbPrihod);
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(txtIznos, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiActionPerformed
        List<Prihod> entiteti = obrada.read();
        var red = tbPrihod.getSelectedRow();
    ...
    private javax.swing.JTable tbPrihod;
